...
const Navbar: FC<NavbarProps> = (props: NavbarProps) => {
  ...
  const { bgColor: backgroundColor } = props
  ...
  return (
    <Box
      ...
      top={0}
      zIndex='200'
      bg={colorMode === 'light' ? 'white' : '#1F2023'}
    ...
    >
      ...
      <Flex display={{ base: 'flex', md: 'none' }} padding='0' py='1rem' justifyContent={'center'}>
        <Box flex='1'>
          <IconButton
            onClick={onToggle}
            icon={
        ...
        <Link href='/'>
          <Image
            ...
            src={
              colorMode === 'dark'
                ? '/images/ALL-launch-logo-white-beta.svg'
                : '/images/ALL-launch-logo-black-beta.svg'
            }
          />
        </Link>
      </Flex>
            ...
            {navItem.label == 'logo' && (
              <Link href={navItem.href}>
                <Image
                  ...
                  width='auto'
                  src='/images/ALL-launch-logo-black-beta.svg'
                />
              </Link>
            )}
            {navItem.label != 'logo' && (
  ...
  return (
    <Stack bg={bgColor} color={fontColor} py={4} display={{ md: 'none' }}>
      {NAV_ITEMS.map((navItem) => (
        ...
        >
          {navItem.label != 'logo' && (
            <Link href={navItem.href ?? '#'} target={navItem.newTab ? '_blank' : ''}>
              <Box
                p={2}
