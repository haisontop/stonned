...
const faqs: Faq[] = [
  ...
  },
  {
    ...
    text: `Nuked Apes are not your usual NFTs, as they give you access to the elaborated Stoned Ape Crew ("SAC") Ecosystem. This means access to exclusive SAC Alpha and WL spots, cannabis discounts (soon), an entry ticket to the Amsterdam launch party (April or May) and other exclusive benefits. You can also stake your Nuked Ape, earn $PUFF and create a passive income!`
  },
  {
