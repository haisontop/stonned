...
export default function Footer() {
  return (
    <Flex 
      ...
      <Stack direction={{base: 'column', md: 'row'}} spacing={3} alignItems='center' justifyContent='center' flex='2' p={{base: '1rem 0', md: '0'}}>
        {linksText.map((link) => (      
            <Box key={link.label}>
              {link.label != 'logo' &&
                <Link
      ...
      <Stack direction='row' alignItems='center' justifyContent={{base: 'center', md:'flex-end'}} spacing={5} flex='1'>
        {linksIcons.map((linkIcon, i) => (
          <Link key={linkIcon.href} href={linkIcon.href} target='_blank' role='group'>
            <Icon 
              key={i} 
              color='black'
      ...
      //   <Image display={{ base: 'block', md: 'none' }} width={{ base: '150px', md: '200px' }} src='/images/head.jpg' />
      //   <Stack
      //     width='70%'
      ...
      //     spacing={{ base: '3rem' }}
      //   >
      //     <Stack flex='1 1 0px' spacing={{ base: '0.5rem', md: '1.25rem' }} justifyContent='center' alignItems='center'>
      //       {links.map((l, i) => (
      //         <Text key={i} fontSize={{ md: 'xl' }} fontFamily='heading' as='a' href={l.href} target='_blank'>
      //           {l.label}
      //         </Text>
      //       ))}
      //     </Stack>
      //     <Image display={{ base: 'none', md: 'block' }} width={{ base: '150px', md: '200px' }} src='/images/head.jpg' />
      //     <Stack flex='1 1 0px' spacing={{ base: '0.5rem', md: '1.25rem' }} justifyContent='center' alignItems='center'>
      ...
      //     </Stack>
      //   </Stack>
      //   <Text pl='-5rem' fontSize='sm' fontFamily='heading'>
      //     Built with love on <Image display='inline-block' width='30px' src='/images/sol-logo.png' /> Solana
      //   </Text>
      // </Stack>
  )
}
