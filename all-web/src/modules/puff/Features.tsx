...
const features = [
  {
    title: 'Utility',
    text: '$PUFF Token is the utility token used all over the SAC Ecosystem as well as in the Cannabis Industry to pay for CBD, Weed & other Accessoires. The first-ever Token to get your Greens.',
    icon: <>&#128188;</>,
  },
  {
    title: 'Tokenomics',
    text: 'First token in the Solana ecosystem which incorporates mechanisms of game-theory as well as intelligent burning mechanisms to increase the value.',
    icon: <>&#128293;</>,
  },
  {
    title: 'Team',
