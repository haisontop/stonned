    ...
    <Stack id='tokenomics' spacing={'2rem'} paddingY='2rem' zIndex={1}>
      ...
      <Box fontSize={['md', 'lg']}>
        ...
        <Text fontSize='sm'>
          ...
          mechanisms of game-theory as well as intelligent burning mechanisms to
          increase the value. To estimate any value of token it’s always
          ...
          <SimpleGrid columns={[1]}>
            <Stack>
              <Text fontSize='smaller'>
                ...
                NFTs. The staking rewards
                are constant. The rest of the supply is used to stabilize the
                ...
                <br />
                <br /> There are lots of burning mechanics in place that reduce
            ...
            <Box display='flex' alignItems={'center'} flexDirection={['column', 'row']}>
              ...
              <Box width={['100%', '50%']} pb={[2, 0]}>
                <Heading fontSize='md' fontWeight={'700'} fontFamily={'body'} textAlign='left'>
                  SAC Merch, CBD Online-Store & Cannabis Stores
                </Heading>
                <Text fontSize='sm' textAlign='left'>
                  $PUFF can be used in our online stores to pay for apparel,
                  weed accessories, CBD products & already in five dispensaries
                  in the US. For our first merch drop, all the $PUFF will be burned.
                </Text>
              </Box>
