      ...
      <Stack direction='row' p='3'>
        ...
        >
          ...
          {new Date().getTime() > revealDate.getTime() ? (
              <Stack p={2}>
                <Heading textAlign='center' size='md' color='gray.500' fontSize='1rem'>
                  Ready to Reveal
                </Heading>
                <Button
                  isLoading={loading}
              ...
              <Stack justifyContent='center' d='flex' spacing={0} pb={2}>
                <Heading size='md' color='gray.500' textAlign='center' fontSize='1rem'>
                  Ready To Reveal In
                </Heading>
                <Heading size='lg' color='gray.700' textAlign='center' fontSize='1rem'>
