  ...
  >
      ...
      <Stack direction={{base:'column', md:'row'}} spacing='1rem'>
        ...
        >
          ...
          <Text textAlign='center'>
            <GradientText as='span' fontWeight='700' fontFamily='Montserrat'>SOLD OUT</GradientText>
            <br/>
            <Text color='textGreyDark' fontSize='.8rem' fontWeight='500' textAlign='center'>in 42 seconds</Text>
          </Text>
