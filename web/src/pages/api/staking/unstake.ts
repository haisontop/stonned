...
export default async (req: NextApiRequest, res: NextApiResponse) => {
  ...
  switch (method) {
    case 'POST':
      ...
      const unstakeInstr = await program.instruction.unstake(
        ...
        allReward,
        {
          accounts: {
            ...
            userAllTokenAccount: userAllTokenCreation.address,
      ...
      if (userAllTokenCreation.instructions.length > 0) {
        transaction.add(...userAllTokenCreation.instructions)
      }
